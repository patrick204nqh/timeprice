...
# The data pipeline shares the on-disk schema definition with the gem itself
# via {Timeprice::Schema}. Make `lib/` discoverable when these files are
# invoked directly via `ruby tools/data_pipeline/...`. Rake tasks already
# put the gem on the load path; this guard handles the direct-invoke case.
